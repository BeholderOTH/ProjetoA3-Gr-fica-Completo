...
public class EventListener implements GLEventListener {
    ...
    public void inicializarVariaveis() {
        ...
        nivel=1;
        posicaoBarraXFrontal = 20.0f;
        posicaoBarraXTraseira = -20.0f;
    ...
    private void iniciaFase2() {
        nivel = 2;
        velocidadeX = velocidadeX * 1.65f;
        velocidadeY = velocidadeY * 1.65f;
    }
    ...
    private void barra(GL2 gl) {
        ...
        gl.glVertex2f(posicaoBarraXTraseira, -45.0f);
        gl.glVertex2f(posicaoBarraXFrontal, -45.0f);
    ...
    public void moverBarraEsquerda(){
        if(posicaoBarraXTraseira - 3 <= xMinTela){
            ...
            posicaoBarraXFrontal = posicaoBarraXTraseira + 40;
        }
        else{
    ...
    public void moverBarraDireita(){
        if(posicaoBarraXFrontal + 3 >= xMaxTela){
            ...
            posicaoBarraXTraseira = posicaoBarraXFrontal - 40;
        }
        else{
            posicaoBarraXFrontal += 3;
            posicaoBarraXTraseira += 3;
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        if (sairTelaInicial) {
            ...
            if (centroEsferaY - raioY <= -45.0f && centroEsferaX >= posicaoBarraXTraseira && centroEsferaX <= posicaoBarraXFrontal) {
                float centroBarra = (posicaoBarraXTraseira + posicaoBarraXFrontal) / 2.0f;
                float distanciaVertical = Math.abs(centroEsferaY - (-45.0f)); // Distância vertical entre o centro da esfera e a parte superior da barra
                ...
                if (distanciaVertical < raioY && distanciaHorizontal < (posicaoBarraXFrontal - posicaoBarraXTraseira) / 2.0f) {
                    ...
                    centroEsferaY = -45.0f + raioY + 0.1f;
                    velocidadeY = -velocidadeY;
                    numPlacar += 5;
                }
            }

            if (centroEsferaY <= -45.0f && centroEsferaY >= -55.0f) {
